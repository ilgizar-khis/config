...
declare module 'gi://GstCodecParsers?version=1.0' {
    ...
    export namespace GstCodecParsers {
         ...
         * @since 1.6
         */
        function h264_parser_parse_subset_sps(
            nalparser: H264NalParser,
            nalu: H264NalUnit,
            sps: H264SPS,
        ): H264ParserResult;
         ...
         */
        function h264_video_calculate_framerate(
            sps: H264SPS,
         ...
         * @since 1.26
         */
        function jpeg_bit_writer_restart_interval(
            interval: number,
            size: number,
        ): [JpegBitWriterResult, number, number];
        /**
         ...
         * @since 1.26
         */
        function jpeg_bit_writer_scan_header(
         ...
         * @returns a {@link GstCodecParsers.VC1ParserResult}
         */
        function vc1_parse_sequence_header_struct_a(
            data: number,
            size: number,
         ...
         * @returns a {@link GstCodecParsers.VC1ParserResult}
         */
        function vc1_parse_sequence_header_struct_b(
            data: number,
            size: number,
         ...
         * @returns a {@link GstCodecParsers.VC1ParserResult}
         */
        function vc1_parse_sequence_header_struct_c(
            data: number,
            size: number,
